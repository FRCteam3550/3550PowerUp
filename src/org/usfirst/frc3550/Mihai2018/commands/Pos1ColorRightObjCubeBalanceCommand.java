...
public class Pos1ColorRightObjCubeBalanceCommand extends CommandGroup {
    ...
    public Pos1ColorRightObjCubeBalanceCommand() {
    	addSequential(new DriveDistanceCommand(240, 1)); // 0:Backward / 1:Forward
    	...
    	addSequential(new DriveDistanceCommand(40, 1));
    	addSequential(new OuvrePince());
    }

    // Called just before this Command runs the first time
    protected void initialize() {
    	//System.out.println("Running Pos1ColorRightObjCubeBalanceCommand.java");
    }
